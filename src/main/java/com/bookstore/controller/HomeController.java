...
import com.bookstore.utility.ROConstants;
...
public class HomeController {
	...
	public String setDefaultShippingAddress(@ModelAttribute("defaultUserShippingAddressId") Long defaultShippingId, Principal principal,
			Model model) {
